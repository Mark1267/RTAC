...
function picker(){
    ...
    $namesPicked = rand(0, (count($names) - 1));
    $type = rand(0, 1) ? 'withdrew' : 'deposited';
    // return [$names[$namesPicked] , $counrty[$counrtyPicked]['name'] , rand(50,99999),  $type];
    return "['" . $names[$namesPicked] . "', '" . $counrty[$counrtyPicked]['name'] . "', " . rand(50,20000) . ", '$type']";
}
