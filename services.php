...
<!--PAGE TITLE-->
<section class="page_header" style="background-image: url(<?php echo BASE_URL . '/assets/open/images/servi.jpg'?>) !important;">
  <div class="container">
    <div class="row">
    ...
    <div class="row">
      <div class="col-sm-4">
        <div class="service_wrap heading_space">
          ...
          <p class="bottom15">Rocktera Bitcoin Trust.  Rocktera's flagship product, the Bitcoin Investment Trust (symbol: RBTC), is a private, open-ended trust that is invested exclusively in bitcoin and derives its value solely from the price of bitcoin...</p>
      ...
      <div class="col-sm-4">
        <div class="service_wrap heading_space">
          ...
          <p class="bottom15">Rocktera Digital Large Cap Fund. A strategic large cap fund for diversified exposure.</p>
          <a href="<?php echo BASE_URL . '/detail'; ?>" class="btn-border border_radius text-uppercase">Learn More</a>
        </div>
      </div>
      <!-- <div class="col-sm-4">
