...
<body style="padding: 0; margin: 0; background: rgb(248, 248, 248); font-family: Arial; font-size: 15px;">
    <div class="container" style="background-color:white; max-width: 1000px; margin: 0px auto; position: relative;">
        <div style=" padding: 10px; background: #bde884;">
        ...
        <div style="position: relative; padding: 25px;">
            <div style="width: 100% !important; font-size: 30px;">
                <h4 style="text-align: center; text-transform: capitalize; margin: 0;">Withdrawal Successful.</h4>
            </div>
            <div style="width: 93.33%; display: block; margin: 0px auto;">
                <h5>Hi #name#, </h5>
            </div>
            <div style="padding: 10px; word-wrap: break-word;">
                <span style="line-height: 20px;">Thank you for your withdrawal!. We've accepted your withdrawal request Transaction ID: <span style="font-family: monospace;">#trans_id#</span>. And it has been proccesed successfully.</span>
                <a href="https://rocktera-assets/signin" class="btn" style="margin: 15px auto; display: block; text-align: center; padding: 16px 30px; border-radius: 4px; color: white; background-color: #73ae20; text-decoration: none;">Dashboard</a>
                ...
                <tr style="padding: 10px; background-color:  #d6f0b3;">
                    ...
                    <td style="padding: 10px;">Withdrawal Successful</td>
                </tr>
                <tr style="padding: 10px; background-color:  #d6f0b3;">
