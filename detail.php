        ...
        <div class="tab_container">
          ...
          <div id="tab1" class="tab_content">
            <div class="services_content">
              ...
              <p class="bottom30"> Rocktera Bitcoin Trust.  Rocktera's flagship product, the Bitcoin Investment Trust (symbol: RBTC), is a private, open-ended trust that is invested exclusively in bitcoin and derives its value solely from the price of bitcoin. It enables investors to gain exposure to the price movement of bitcoin without the challenges of buying, storing, and safekeeping bitcoins.</p>

<p class="bottom40">• Rocktera Bitcoin Cash Trust. An alternative approach for electronic cash.</p>

<p class="bottom40">• Rocktera Ethereum Trust. A decentralized, smart-contract platform.</p>

<p class="bottom40">• Rocktera Ethereum Classic Trust. A flexible currency for the Internet of Things.</p>

<p class="bottom40">• Rocktera Litecoin Trust. A digital currency for fast, low-cost payments.</p>

<p class="bottom40">• Rocktera Stellar Lumens Trust. A platform that connects banks, payment systems, and people.
</p>
              <div class="row">
                <div class="col-md-5">
...
We will remain a privately owned, independent firm to ensure that we act in the best interest of our clients and employees.</p>
          ...
          <div id="tab2" class="tab_content">
            <div class="services_content">
              ...
              <p class="bottom30">• Rocktera Digital Large Cap Fund. A strategic large cap fund for diversified exposure.</p>
              <div class="row">
                <div class="col-md-5">
                  <h2 class="bottom10">Key<span class="blue_t">Benefits</span></h2>
                  <div class="accordion-container">
